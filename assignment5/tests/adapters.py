...
from cs336_alignment.helper_methods import *
...
def run_tokenize_prompt_and_output(
    ...
    """
    output_temp = tokenize_prompt_and_output(prompt_strs, output_strs, tokenizer)
    output = {
        'input_ids':output_temp['input_ids'],
        'labels':output_temp['labels'],
        'response_mask':output_temp['response_mask'],
        }
    return output
